...
export function PlaceholderCard({
  ...
  return (
    <article className={cn('surface-card interactive-card p-6', className)}>
      <div className="flex items-start justify-between gap-4">
        <span className="grid h-9 w-9 shrink-0 place-items-center rounded-xl border border-[#CBD5E1] bg-[#F1F5F9] text-[#475569]">
      ...
      <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-[#64748B]">{eyebrow}</p>
